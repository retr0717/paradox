      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10 text-center sm:text-left">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-muted-foreground text-sm sm:text-base leading-relaxed font-monserrat-bold font-bold">
          ...
          <div className="mx-auto">
            <h4 className="font-semibold mb-3 sm:mb-4 text-base sm:text-lg font-monserrat-bold font-bold">
              Quick Links
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3 text-muted-foreground text-sm sm:text-base font-monserrat-bold font-bold">
        ...
        >
          <p className="text-muted-foreground text-sm sm:text-base font-monserrat-bold font-bold">
            © 2025 PARADOX. All rights reserved.
          </p>
          <p className="text-muted-foreground/70 text-xs sm:text-sm mt-2 font-monserrat-bold font-bold">
